...
$closeCart = apply_filters('pisol_close_cart_link',"");
?>
<div class="pisol_grid">
<div class="pisol_cat">
	<?php do_action('pisol_product_category'); ?>
</div>
<div class="pisol_cart"  id="pisol-cart-anchor">
<?php
						...
						<td class="product-remove">
							<?php
								...
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									...
									__( 'Remove this item','pisol-restautant-menu' ),
									esc_attr( $product_id ),
